...
export default function MapLegend({ mapType }: Props) {
  ...
  const gradientStops = data.stops
    ...
    .join(", ");
  return (
    <div className="absolute top-4 right-4 z-1000 w-48 xs:w-96 rounded-xl shadow-lg p-4 bg-background/50 border border-accent/70 flex flex-col">
      ...
      />
      <div className="flex justify-between text-xs text-foreground mt-2 px-1">
        <span>
